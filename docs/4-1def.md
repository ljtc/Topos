...
$$A\times 1\to A\xrightarrow{\varphi_m}\Omega$$. Así, hay una única $$\hat{\varphi}_m\colon 1\to\Omega$$ que hace conmutar al diagrama de la definición de objetos potencia.
...
$$\varphi_m\,x=v_X \iff \in_A(x,\hat{\varphi}_m)=v_X$$.
